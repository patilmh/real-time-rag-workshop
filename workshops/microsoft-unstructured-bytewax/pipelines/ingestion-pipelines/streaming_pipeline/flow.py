...
## from streaming_pipeline import mocked                        # causes problems on Azure functions
...
def build(
    ...
    try:
        ...
        if debug:
            ...
            # Write to file in debug mode - Azure function only allows writing to /tmp
            op.output("fileout", serialized, FileSink('/tmp/data/news_out.jsonl'))
        ...
        op.output("std_out", news_stream, StdOutSink())
        ...
        # Batch for either 100 elements, or 120 seconds. This should emit at
